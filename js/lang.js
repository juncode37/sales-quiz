  ...
  const translations = {
    ru: {
      ...
      hiring_now_2: `Новички + <span class="text-grad">кандидаты 
             с опытом</span>`,
      hero_title: `<span class="text-grad">Менеджер по продажам в соцсетях.</span> 
            <br>
            Работа в <span class="text-grad">переписке и звонки.</span>
            `,
      hero_sub: `Ищем активных ребят 18–25 лет из Киева, Львова и <span class="text-glow">Ивано-Франковска</span>. Обучаем, даём готовые скрипты и помогаем выйти на хороший доход.`,
      ...
      role_team_t_4: "Скрипты, поддержка",
      role_team_d_4:
      ...
      section_roles_b_3:
        "Формат - переписка, системная работа и понятные процессы",
    ...
    ua: {
      ...
      hiring_now_2: `Новачки + <span class="text-grad">кандидати 
             з досвідом</span>`,
      hero_title: `<span class="text-grad">Менеджер з продажів у соцмережах.</span> 
            <br>
            Робота в <span class="text-grad">переписці та дзвінки.</span>
            `,
      hero_sub: `Шукаємо активних хлопців і дівчат 18–25 років з Києва, Львова та <span class="text-glow">Івано-Франківська</span>. Навчаємо, даємо готові скрипти та допомагаємо вийти на хороший дохід.`,
      bonus_buyer: "Sign-on бонус (Buyer)",
      bonus_lead: "Для Team Lead + Команда",
      ...
      role_team_t_4: "Скрипти, підтримка",
      role_team_d_4:
      ...
      section_roles_b_3:
        "Формат — переписка, системна робота і зрозумілі процеси",
